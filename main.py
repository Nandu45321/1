...
def snackbarforinput():
    Snackbar(
        text="[color=#ff6961]Please fill the all the required blanks[/color]",).open()
            ...
            class Screen_about(Screen):
                def load_table(self):
                    ...
                    self.data_table = MDDataTable(pos_hint={"center_x": 0.5, "center_y": 0.5},
                        ...
                        ("Dart", "Discord-KivyMD",
                                 "MDDataTable, Buildozer, GridLayout, Bugs, IconLeftWidgetWithoutTouch"),
                        ("neon jadd", "Discord-KivyMD",
                         "MDDataTable, GridLayout, MDList, Performance, NavigationDrawer"),
                        ("Yuri Ivanov", "Discord-KivyMD",
                         "Bug, IconLeftWidgetWithoutTouch"),
                        ("darpan5552", "Discord-KivyMD", "InnerIcons"),
                        ("zdayX", "Discord-KivyMD", "InnerApp"),
                        ("RobertFlatt", "Discord-Kivy", "Kivy"),
                        ("VICTOR D.VICIKIE",
                         "Discord-Kivy", "Kivy-size_hint"),
            ...
            class Screen_formulas_3d(Screen):
                def load_table(self):
                    ...
                    self.data_table = MDDataTable(pos_hint={"center_x": 0.5, "center_y": 0.5},
                        ...
                        row_data=[
                        ("1.", "Cube", "edge**3", "6*(edge*edge)", "4*(edge*edge)",
                         "---", "---", "(3**(1/2))*edge", "---", "---"),
                        ("2.", "Cuboid", "lenght*breadth*height", "2*((lenght*breadth)+(breadth*height)+(lenght*height))",
                         "---", "---", "---", "((lenght*lenght)+(breadth*breadth)+(height*height))**(1/2)", "---", "---"),
                        ("3.", "Triangular Prism", "ar_base*height", "(2*ar_base)+((side1+side2+side3)*height)",
                         "(side1+side2+side3)*height", "((s*(s-side1)*(s-side2)*(s-side3))**(1/2))", "---", "---", "---", "---"),
                        ("4.", "Triangular Pyramid", "(1/3)*ar_base*height", "ar_base+((1/2)*(pr_base*sl_height))",
                         "(1/2)*(pr_base*sl_height)", "---", "---", "---", "---", "---"),
                        ("5.", "Square Pyramid", "(side*side)*(height/3)", "(side*side)+(2*side)*(((side*side)/4)+(height*height))**(1/2)",
                         "side*((side*side)+4*(height*height))**(1/2)", "side*side", "(side/2)*(((side*side)/4)+(height*height))**(1/2)", "---", "---", "---"),
                        ("6.", "Rectanglular Pyramid", "(lenght*breadth*height)/3", "(lenght*breadth)+lenght*((((breadth/2)**2)+(height*height))**(1/2))+breadth*((((lenght/2)**2)+(height*height))**(1/2))",
                         "lenght*((((breadth/2)**(2))+(height*height))**(1/2))+breadth*((((lenght/2)**(2))+(height*height))**(1/2))", "lenght*breadth", "---", "---", "---", "---"),
                        ("7.", "Pentagonal Pyramid", "(5/12)*tan(54)*height*(side*side) #1.376", "(5/4)*tan(54)*(side*side)+(5*(side/2))*((height*height)+(((side*tan(54))/2)**2))**(1/2)",
                         "(5*side*((height*height)+(((side*tan(54))/2)**2))**(1/2))/2", "(5/4)*tan(54)*side*side #1.376", "(side/2)*((height*height)+(((side*side)/2)**2))**(1/2)", "---", "---", "---"),
                        ("8.", "Hexagonal Pyramid", "((3**(1/2))/2)*(side*side)*height", "((3*(3**(1/2)))/2)*(side*side)+(3*side)*((height*height)+((3*side*side)/4))**(1/2)",
                         "(3*side)*((height*height)+((3*side*side)/4))**(1/2)", "((3*(3**(1/2)))/2)*(side*side)", "(side/2)*((height*height)+((3*side*side)/4))**(1/2)", "---", "---", "---"),
                        ("9.", "Tetrahedron", "(side*side*side)/(6*(2**(1/2)))", "(3**(1/2))*side*side",
                         "---", "---", "((3**(1/2))/4)*side*side", "---", "((2/3)**(1/2))*side", "---"),
                        ("10.", "Octahedron", "((2**(1/2))/3)*(side**3)",
                         "2*(3**(1/2))*side*side", "---", "---", "---", "---", "---", "---"),
                        ("11.", "Dodecahedron", "((15+7*(5**(1/2)))/4)*(side*side*side)",
                         "3*((25+10*((5**(1/2))))**(1/2))*side*side", "---", "---", "---", "---", "---", "---"),
                        ("12.", "Icosahedron", "((5*(3+(5**(1/2))))/12)*(side*side*side)",
                         "5*(3**(1/2))*(side*side)", "---", "---", "---", "---", "---", "---"),
                        ("13.", "Sphere", "(4/3)*(pie)*(radius*radius*radius)", "4*(pie)*(radius*radius)",
                         "---", "---", "---", "2*radius", "---", "2*(pie)*radius"),
                        ("14.", "Hemi-Sphere", "(2/3)*(pie)*(radius*radius*radius)", "3*(pie)*(radius*radius)",
                         "2*(pie)*radius*radius", "(pie)*radius*radius", "---", "2*radius", "---", "2*(pie)*radius"),
                        ("15.", "Ellipsoid", "(4/3)*(pie)*x*y*z", "4*(pie)*((((x*y)**(1.6))+((x*z)**(1.6))+((y*z)**(1.6)))/3)**(1/1.6)",
                         "---", "---", "---", "---", "---", "---"),
                        ("16.", "Cylinder", "(pie)*radius*radius*height", "(2*(pie)*radius*height)+(2*(pie)*radius*radius)",
                         "2*(pie)*radius*height", "(pie)*radius*height", "---", "2*radius", "---", "---"),
                        ("17.", "Cone", "(pie)*radius*radius*(height/3)", "(pie)*radius*(radius+((height*height)+(radius*radius))**(1/2))",
                         "(pie)*radius*(((height*height)+(radius*radius))**(1/2))", "(pie)*radius*radius", "---", "2*radius", "((radius*radius)+(height*height))**(1/2)", "---"),
                        ("18.", "Torus", "2*((pie)**2)*radius1*((radius2)**2)",
                         "4*((pie)**2)*radius1*radius2", "---", "---", "---", "---", "---", "---")
                    ]
                    )
                    self.add_widget(self.data_table)
                    return layout
                ...
                def load_table(self):
                    ...
                    self.data_table = MDDataTable(pos_hint={"center_x": 0.5, "center_y": 0.5},
                        ...
                        ("1.", "Triangle", "(1/2)*base*height",
                         "---", "---", "---", "---"),
                        ("2.", "Equilateral Triangle", "((3**(1/2))/4)*side*side",
                         "3*side", "---", "---", "---"),
                        ("3.", "Right Triangle", "(side1*side2)/2", "side1+side2+hypotenuse",
                                                 "---", "---", "((side1*side1)+(side2*side2))**(1/2)"),
                        ("4.", "Isosceles Triangle", "(side/2)*((side*side)-(common*common))**(1/2)",
                         "(2*common)+side", "---", "---", "2*(area/side)"),
                        ("5.", "Scalene Triangle", "(s*(s-side1)*(s-side2)*(s-side3))**(1/2)",
                         "s*2", "---", "---", "---"),
                        ("6.", "Quadrilateral", "((1/2*diagnol*dia1)+(1/2*diagnol*dia2))",
                         "---", "---", "---", "---"),
                        ("7.", "Square", "side*side",
                         "4*side", "---", "---", "---"),
                        ("8.", "Rectangle", "lenght*width",
                         "2*(lenght+width)", "---", "---", "---"),
                        ("9.", "Rhombus", "(dia1*dia2)/2", "2*((dia1*dia1)+(dia2*dia2))**(1/2)",
                         "---", "(((dia1/2)*(dia1/2))+((dia2/2)*(dia2/2)))**(1/2)", "---"),
                        ("10.", "Kite", "(dia1*dia2)/2",
                         "2*(side1+side2)", "---", "---", "---"),
                        ("11.", "Parallelogram", "base*height",
                                                 "2*(side+base)", "---", "---", "---"),
                        ("12.", "Trapezium", "(1/2)*(par1+par2)*height",
                         "par1+par2+side1+side2", "---", "---", "---"),
                        ("13.", "Regular Pentagon", "(1/4)*((5*(5+2*(5**(1/2))))**(1/2))*(side*side)",
                         "5*side", "((1+(5**(1/2)))/2)*side", "---", "---"),
                        ("14.", "Regular Hexagon", "((3*(3**(1/2)))/2)*(side*side)",
                         "6*side", "---", "---", "---"),
                        ("15.", "Regular Heptagon", "(7/4)*(side*side)*cot(180/7) #2.0765",
                         "7*side", "---", "---", "---"),
                        ("16.", "Regular Octagon", "2*(1+(2**(1/2)))*(side*side)",
                         "8*side", "---", "---", "---"),
                        ("17.", "Regular Nonagon", "(9/4)*(side*side)*cot(180/9) #2.747",
                         "9*side", "---", "---", "---"),
                        ("18.", "Regular Decagon", "(5/2)*(side*side)*(5+2*(5**(1/2)))**(1/2)",
                         "10*side", "---", "---", "---"),
                        ("19.", "Circle", "(pie)*radius*radius",
                         "2*(pie)*radius", "2*radius", "---", "---"),
                        ("20.", "Semi-Circle", "(1/2)*((pie)*(radius*radius))",
                         "((pie)*radius)+(2*radius)", "2*radius", "---", "---"),
                        ("21.", "Ellipse", "(pie)*x*y",
                         "(pie)*(3*(x+y)-(((3*x+y)*(x+3*y))**(1/2)))", "---", "---", "---")
                    ]
                    )
                    self.add_widget(self.data_table)
                    return layout
...
class RightTriangleWindow(Screen):
    def queans(self):
        ...
        if side1_input != '' and side2_input != '':
            answer = Shapes.right_triangle(
                float(side1_input), float(side2_input))
            self.ids.area_value.hint_text = str(answer[0])
            self.ids.perimeter_value.hint_text = str(answer[1])
...
class IsoscelesTriangleWindow(Screen):
    def queans(self):
        ...
        try:
            ...
            snackbarforinput()
        if base_input != '' and height_input != '':
            answer = Shapes.iso_triangle(
                float(base_input), float(height_input))
            self.ids.area_value.hint_text = str(answer[0])
            self.ids.perimeter_value.hint_text = str(answer[1])
...
class ScaleneTriangleWindow(Screen):
    def queans(self):
        ...
        if side1_input != '' and side2_input != '' and side3_input != '':
            answer = Shapes.scal_triangle(
                float(side1_input), float(side2_input), float(side3_input))
            self.ids.area_value.hint_text = str(answer[0])
            self.ids.perimeter_value.hint_text = str(answer[1])
...
class QuadrilateralWindow(Screen):
    def queans(self):
        ...
        if large_dia_input != '' and small_dia_1_input != '' and small_dia_2_input != '':
            answer = Shapes.quad(
                large_dia_input, small_dia_1_input, small_dia_2_input)
            self.ids.area_value.hint_text = str(answer[0])
            self.ids.perimeter_value.hint_text = str(answer[1])
...
class KiteWindow(Screen):
    def queans(self):
        ...
        if dia_1_input != '' and dia_2_input != '' and side_1_input != '' and side_2_input != '':
            answer = Shapes.kite(dia_1_input, dia_2_input,
                                 side_1_input, side_2_input)
            self.ids.area_value.hint_text = str(answer[0])
            self.ids.perimeter_value.hint_text = str(answer[1])
...
class TrapeziumWindow(Screen):
    def queans(self):
        ...
        if par_1_input != '' and par_2_input != '' and height_input != '' and side_1_input != '' and side_2_input != '':
            answer = Shapes.trap(par_1_input, par_2_input,
                                 height_input, side_1_input, side_2_input)
            self.ids.area_value.hint_text = str(answer[0])
            self.ids.perimeter_value.hint_text = str(answer[1])
...
class TriangularPrismWindow(Screen):
    def queans(self):
        ...
        if side_1_input != '' and side_2_input != '' and side_3_input != '' and height_input != '':
            answer = Shapes.tri_prism(
                side_1_input, side_2_input, side_3_input, height_input)
            self.ids.volume_value.hint_text = str(answer[0])
            self.ids.tsa_value.hint_text = str(answer[1])
            self.ids.lsa_value.hint_text = str(answer[2])
...
class TriangularPyramidWindow(Screen):
    def queans(self):
        ...
        if ar_base_input != '' and pr_base_input != '' and sl_height_input != '' and height_input != '':
            answer = Shapes.tri_pyramid(
                ar_base_input, pr_base_input, sl_height_input, height_input)
            self.ids.volume_value.hint_text = str(answer[0])
            self.ids.tsa_value.hint_text = str(answer[1])
            self.ids.lsa_value.hint_text = str(answer[2])
...
class RectanglePyramidWindow(Screen):
    def queans(self):
        ...
        try:
            ...
            snackbarforinput()
        if length_input != '' and breadth_input != '' and height_input != '':
            answer = Shapes.rect_pyramid(
                length_input, breadth_input, height_input)
            self.ids.volume_value.hint_text = str(answer[0])
            self.ids.tsa_value.hint_text = str(answer[1])
            self.ids.lsa_value.hint_text = str(answer[2])
            self.ids.ar_base_value.hint_text = str(answer[3])
